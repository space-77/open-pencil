...
export namespace __common__ {
  ...
  export interface InternalhandlerGetAllAIConfigsResponse {
    /**
     * @example 200
     * @description 状态码
     */
    ...
    data?: {
       ...
       * @description 配置列表
       */
      configs?: Array<__common__.InternalhandlerAIConfigItem>
    }
    /**
     * @example 获取成功
     * @description 提示消息
  ...
  export interface InternalhandlerCreateAIConfigRequest {
    /**
     * @example sk-xxx
     * @description API Key
     */
  ...
  export interface InternalhandlerCreateAIConfigResponse {
    /**
     * @example 200
     * @description 状态码
     */
  ...
  export interface InternalhandlerGetAIConfigResponse {
    /**
     * @example 200
     * @description 状态码
     */
  ...
  export interface InternalhandlerUpdateAIConfigRequest {
    /**
     * @example sk-xxx
     * @description API Key
     */
  ...
  export interface InternalhandlerUpdateAIConfigResponse {
    /**
     * @example 200
     * @description 状态码
     */
  ...
  export interface InternalhandlerCreateAIConfigData {
    /**
     * @example sk-****x
     * @description API Key 脱敏
     */
  ...
  export interface InternalhandlerGetAIConfigData {
    /**
     * @example sk-****x
     * @description API Key 脱敏
     */
  ...
  export interface InternalhandlerAIConfigItem {
    /**
     * @example sk-****x
     * @description API Key 脱敏
     */
  ...
  export interface InternalhandlerGetAllAIConfigsData {
    /**
     * @description 配置列表
     */
    configs?: Array<__common__.InternalhandlerAIConfigItem>
  ...
  export interface InternalhandlerUpdateAIConfigData {
    /**
     * @example sk-****x
     * @description API Key 脱敏
     */
...
export namespace AIConfig {
  export interface GetAiConfigsRes extends __common__.InternalhandlerGetAllAIConfigsResponse {}

  export interface PostAiConfigsRes extends __common__.InternalhandlerCreateAIConfigResponse {}

  /**
   * @description 创建请求参数
   */
  export interface PostAiConfigsBody extends __common__.InternalhandlerCreateAIConfigRequest {}

  export interface GetAiConfigsByIdRes extends __common__.InternalhandlerGetAIConfigResponse {}

  export interface GetAiConfigsByIdParams {
    /**
     * @example "aic_xxx"
     * @description 配置ID
     */
  ...
  export interface PutAiConfigsByIdRes extends __common__.InternalhandlerUpdateAIConfigResponse {}

  export interface PutAiConfigsByIdParams {
    /**
     * @example "aic_xxx"
     * @description 配置ID
     */
   ...
   * @description 更新请求参数
   */
  export interface PutAiConfigsByIdBody extends __common__.InternalhandlerUpdateAIConfigRequest {}

  export interface DeleteAiConfigsByIdRes extends __common__.PkgresponseResponse {}

  export interface DeleteAiConfigsByIdParams {
    /**
     * @example "aic_xxx"
     * @description 配置ID
     */
  ...
  export type RGetAiConfigs = Promise<
    [
      any,
      __common__.InternalhandlerGetAllAIConfigsResponse['data'],
      __common__.InternalhandlerGetAllAIConfigsResponse
    ]
  >
  export type RPostAiConfigs = Promise<
    [
      any,
      __common__.InternalhandlerCreateAIConfigResponse['data'],
      __common__.InternalhandlerCreateAIConfigResponse
    ]
  >
  export type RGetAiConfigsById = Promise<
    [
      any,
      __common__.InternalhandlerGetAIConfigResponse['data'],
      __common__.InternalhandlerGetAIConfigResponse
    ]
  >
  export type PutAiConfigsByIdParams1 = PutAiConfigsByIdParams &
    __common__.InternalhandlerUpdateAIConfigRequest

  export type RPutAiConfigsById = Promise<
    [
      any,
      __common__.InternalhandlerUpdateAIConfigResponse['data'],
      __common__.InternalhandlerUpdateAIConfigResponse
    ]
  >
  export type RDeleteAiConfigsById = Promise<
    [any, __common__.PkgresponseResponse['data'], __common__.PkgresponseResponse]
  >
}

export namespace Auth {
  export interface PostLoginRes extends __common__.InternalhandlerLoginResponse {}

  /**
   * @description 登录请求参数
   */
  export interface PostLoginBody extends __common__.InternalhandlerLoginRequest {}

  export interface PostRegisterRes extends __common__.InternalhandlerRegisterResponse {}

  /**
   * @description 注册请求参数
   */
  export interface PostRegisterBody extends __common__.InternalhandlerRegisterRequest {}

  export type RPostLogin = Promise<
    [any, __common__.InternalhandlerLoginResponse['data'], __common__.InternalhandlerLoginResponse]
  >
...
export namespace Collaboration {
  export interface PostRoomsRes extends __common__.InternalhandlerCreateRoomResponse {}

  /**
   * @description 创建房间请求参数
   */
  export interface PostRoomsBody extends __common__.InternalhandlerCreateRoomRequest {}

  export interface GetRoomsMyRes extends __common__.InternalhandlerUserRoomListResponse {}

  export interface GetRoomsByIdRes extends __common__.InternalhandlerGetRoomResponse {}
  ...
  export interface PostRoomsByIdCloseRes extends __common__.PkgresponseResponse {}
  ...
  export interface GetRoomsByIdStateRes extends __common__.InternalhandlerRoomStateResponse {}
  ...
  export interface PutRoomsByIdStateRes extends __common__.InternalhandlerUpdateRoomStateResponse {}
   ...
   */
  export interface PutRoomsByIdStateBody extends __common__.InternalhandlerUpdateRoomStateRequest {}
...
export namespace Documents {
  export interface GetDocumentsRes extends __common__.InternalhandlerDocumentListResponse {}
  ...
  export interface PostDocumentsRes extends __common__.InternalhandlerCreateDocumentResponse {}
  ...
  export interface GetDocumentsByIdRes extends __common__.InternalhandlerGetDocumentResponse {}
  ...
  export interface PutDocumentsByIdRes extends __common__.InternalhandlerUpdateDocumentResponse {}
   ...
   * @description 更新请求参数
   */
  export interface PutDocumentsByIdBody extends __common__.InternalhandlerUpdateDocumentRequest {}

  export interface DeleteDocumentsByIdRes extends __common__.PkgresponseResponse {}
   ...
   */
  export interface PutDocumentsByIdContentBody extends __common__.MundefinedBody1 {}
...
export namespace Images {
  export interface PostImagesRes extends __common__.InternalhandlerUploadImageResponse {}
  ...
  export interface PostImagesCheckRes extends __common__.InternalhandlerCheckImagesResponse {}

  /**
   * @description 检查图片请求参数
   */
  export interface PostImagesCheckBody extends __common__.InternalhandlerCheckImagesRequest {}
  ...
  >
  export type RGetImagesByHash = Promise<[any, unknown, Images.GetImagesByHashRes]>
}

export namespace Settings {
  export interface GetSettingsRes extends __common__.InternalhandlerGetAllSettingsResponse {}

  export interface PutSettingsBatchRes extends __common__.InternalhandlerBatchSetResponse {}

  /**
   * @description 批量设置请求参数
   */
  export interface PutSettingsBatchBody extends __common__.InternalhandlerBatchSetRequest {}

  export interface GetSettingsByKeyRes extends __common__.InternalhandlerGetSettingResponse {}
  ...
  export interface PutSettingsByKeyRes extends __common__.InternalhandlerSetSettingResponse {}
   ...
   * @description 设置值请求参数
   */
  export interface PutSettingsByKeyBody extends __common__.InternalhandlerSetSettingRequest {}

  export interface DeleteSettingsByKeyRes extends __common__.PkgresponseResponse {}
