...
## Purpose
Text creation and inline editing. Text tool (T), CanvasKit Paragraph API rendering, textarea overlay for editing, font loading (Inter default + system fonts via Local Font Access API), font weight support.
## Requirements
